...
# def backtracking(node, is_maximizing, graph, pruned_nodes):
...
#             value = backtracking(child, False, graph, pruned_nodes)
#             best_value = max(best_value, value)
#             graph.add_edge(node.value, child.value)  # Add edge for visualization
#             pos = nx.spring_layout(graph)
#             nx.draw(graph, pos, with_labels=True, node_color='lightblue', font_weight='bold', node_size=2000)
...
#         best_value = float('inf')
#         for child in node.children:
#             value = backtracking(child, True, graph, pruned_nodes)
...
##Run backtracking with visualization
# print("Backtracking:")
# backtracking_result = backtracking(node1, True, graph, pruned_nodes)
# print("Backtracking Result:", backtracking_result)

# # Draw the graph for backtracking
pos = nx.spring_layout(graph)
nx.draw(graph, pos, with_labels=True, node_color='lightblue', font_weight='bold', node_size=2000)
plt.title('Backtracking: Final Result')
plt.show()

# Clear the graph for alpha-beta visualization
graph.clear()
